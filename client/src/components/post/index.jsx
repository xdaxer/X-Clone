...
function Post({ post }) {
  ...
  useEffect(() => {
    if (post.PostImagePath) {
      setImageUrl(`http://localhost:3000/cdn/images/posts/${post.PostID}`);
    }
  }, [post.PostImagePath]);
  ...
  return (
    <div>
      <div key={post.PostID} className={style.post}>
        <img
        ...
        <div className={style.details}>
          <div className={style.name}>
            <b>
              <Link to={"/" + post.username}>{post.name}</Link>
            </b>
          ...
          <div className={style.postContent}>
            ...
            {post.PostImagePath && <img src={imageUrl}></img>}
          </div>
